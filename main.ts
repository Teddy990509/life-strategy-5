namespace SpriteKind {
    export const 黑罐子 = SpriteKind.create()
}
info.onCountdownEnd(function () {
    game.setGameOverMessage(true, "Your life is over!")
    game.gameOver(true)
})
sprites.onOverlap(SpriteKind.Player, SpriteKind.Projectile, function (sprite, otherSprite) {
    lossblood = randint(0, -10)
    info.changeCountdownBy(lossblood)
    scene.cameraShake(4, 500)
    otherSprite.destroy(effects.bubbles, 500)
    sprite.sayText("隨機改變" + ("" + lossblood), 500, true)
})
sprites.onOverlap(SpriteKind.Player, SpriteKind.Food, function (sprite2, otherSprite2) {
    ...
    sprite2.sayText("分數變化" + ("" + addscore) + "分!", 500, true)
    music.baDing.play()
})
...
abili = randint(1, 10)
info.startCountdown(randint(20, 40))
game.onUpdateInterval(2000, function () {
    projectile = sprites.createProjectileFromSide(img`
        ...
        ....................
        ....................
        `, randint(-40, 40), randint(-40, 40))
    projectile.y = randint(10, 110)
    projectile.x = randint(10, 110)
